...
(defrule recommend-book-based-on-genre
   ...
   =>
   (printout t "Recommended based on genre preference: " ?b:title crlf))
...
(defrule recommend-book-based-on-author
   ...
   =>
   (printout t "Recommended based on author preference: " ?b:title crlf))
...
(defrule recommend-book-based-on-previous-reads
   ...
   =>
   (printout t "Recommended based on previous reads: " ?b:title crlf))
...
(defrule recommend-bestseller-if-no-other-match
   ...
   =>
   (printout t "Recommended bestseller: " ?b:title crlf))
